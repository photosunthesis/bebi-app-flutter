...
final themeProvider = Provider((_) {
...
final _textTheme = Typography.material2021().black.apply(
...
final _primaryTextTheme = Typography.material2021().black.apply(
...
final _iconTheme = IconThemeData(color: _colorScheme.secondary);
